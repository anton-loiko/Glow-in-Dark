...
|---|---|---|---|
| `floor_{a,b,c,d}.png` + `_n` | 512×512 бесшовная | 3–4 на биом | 🟨 (процедурный пол `ChapterEnvironment`) |
| `prop_<name>.png` + `_n` + полигон `LightOccluder2D` | 96–384 | 8–12 на биом | 🟨 (процедурные пропсы `Chunk`) |
| `biolum_<name>.png` (грибы, светлячки, руны) | 64–128 | 4–6 на биом | ⬜ |
| `fog_layer.png` | 1024×1024 бесшовная | 1 на биом, параллакс 0.8× | ⬜ |
