...
- task_5: ~~контраст скриптом~~ ✅ (`tests/ui/test_contrast.gd`; на ревью: TEXT_DISABLED на INK_600 = 2.79:1), системный Reduce Motion, safe area на устройствах, ревью дизайнером side-by-side.
