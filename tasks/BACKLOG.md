...
- task_8: ~~финальный звук~~ ✅ (`tools/audio/synth_sfx.py`, мастеринг — `docs/asset_specs.md` §9); нативная хаптика iOS и энергосбережение — Swift-плагин, делаем вместе с iOS-сборкой в task_9; скриншоты сторов — снимем с симулятора в task_9; политика конфиденциальности и рейтинг — владелец.
- Осталось по task_5: safe area на устройствах (task_9, симулятор + устройство). ~~Ревью side-by-side~~ ✅ — `docs/ui_review.md`.
