...
var next_spawn_y: float = 0.0 # Начинаем с нуля и строим вниз
...
func _spawn_random_chunk() -> void:
	...
	# Позиционируем чанк ровно под предыдущим
...
func _spawn_exit() -> void:
	...
	if exit_scene:
		...
		# Ставим выход в нижней части последнего чанка
		exit_instance.global_position = Vector2(135, next_spawn_y - 50.0)
